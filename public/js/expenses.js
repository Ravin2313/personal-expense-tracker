...
const categoryIcons = {
    ...
    'Bills & Utilities': 'bi-receipt',
    'Healthcare': 'bi-heart-pulse',
    'Education': 'bi-book',
    'Travel': 'bi-airplane',
    'Groceries': 'bi-basket',
    'Gym & Fitness': 'bi-person-arms-up',
...
const categoryColors = {
    'Food & Dining': 'linear-gradient(135deg, #f59e0b, #d97706)',
    'Transportation': 'linear-gradient(135deg, #06b6d4, #0891b2)',
    'Shopping': 'linear-gradient(135deg, #ec4899, #db2777)',
    'Entertainment': 'linear-gradient(135deg, #8b5cf6, #7c3aed)',
    'Bills & Utilities': 'linear-gradient(135deg, #ef4444, #dc2626)',
    ...
    'Gym & Fitness': 'linear-gradient(135deg, #f59e0b, #d97706)',
    'Personal Care': 'linear-gradient(135deg, #ec4899, #db2777)',
    'Clothing': 'linear-gradient(135deg, #8b5cf6, #7c3aed)',
    'Electronics': 'linear-gradient(135deg, #06b6d4, #0891b2)',
    'Home & Garden': 'linear-gradient(135deg, #10b981, #059669)',
    'Insurance': 'linear-gradient(135deg, #3b82f6, #2563eb)',
    'Investments': 'linear-gradient(135deg, #10b981, #059669)',
    'Gifts & Donations': 'linear-gradient(135deg, #ec4899, #db2777)',
    'Pet Care': 'linear-gradient(135deg, #f97316, #ea580c)',
    'Subscriptions': 'linear-gradient(135deg, #8b5cf6, #7c3aed)',
    'Fuel': 'linear-gradient(135deg, #ef4444, #dc2626)',
    'Parking': 'linear-gradient(135deg, #6b7280, #4b5563)',
